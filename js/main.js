jQuery(document).ready(function($) {
   ...
   jQuery('.tp-banner').show().revolution(
	...
	//Gallery Toggle
	$(".gallerySelection").on("click", function(){
		var year = $(this).attr('href');
		
		$(".gallery").hide("fast");
		
		$("." + year + "Gallery").show("fast");
    ...
    $('#countdown').countdown({until: new Date(2024, 7, 10, 16, 0, 0)}); // enter event day 
	...
	var latlng = new google.maps.LatLng(38.9285412,-94.6573819);
	...
	var marker1 = new google.maps.Marker({
		position: new google.maps.LatLng(38.9285412,-94.6573819), 
		map: map,		
	...
	var infowindow1 = new google.maps.InfoWindow({  
		content:  createInfo('Overland Park Convention Center', '6000 College Blvd,<br />Overland Park, KS 66211,<br />(913) 339-3000<br /><br />')
	}); 
